...
import { newTransferDetail } from '../redux/actions/transfersDetail';
...
const NewTransferDetails = () => {
    ...
    const handleSubmit = () => {
        ...
        if (validator.current.allValid()) {
            dispatch(newTransferDetail(info, state._id));
            reset();
        }else{
            forceUpdate(1);
                ...
                <div className="transfer-content">
                    ...
                    <div className="transfer-body">
                        ...
                        <div className='input-group'>
                            ...
                            <input type="text" name='weightNumber' value={weightNumber} onChange={event => setWeightNumber(event.target.value)} />
...
export default NewTransferDetails;