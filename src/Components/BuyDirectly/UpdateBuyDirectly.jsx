...
import { updateSingleBuyDirectly } from '../redux/actions/buysDirectly';
import { useLocation, useNavigate } from 'react-router-dom';
import CustomDatePicker from '../shared/DatePicker';

const UpdateBuyDirectly = () => {
  ...
  const handleSubmit = () => {
    ...
    if (validator.current.allValid()) {
      dispatch(updateSingleBuyDirectly(info, state._id));
      navigate("/buy-directly/");
    } else {
  ...
  return (
    <div className="transfer">
      <div className="transfer-content">
        <h3 className="transfer-header">ویرایش خرید مستقیم از کشاورز</h3>
        <div className="transfer-body">
          ...
          <div className="input-group">
            ...
            {validator.current.message("number1", number1, "required|numeric|min:2", { messages: { min: 'فرمت پلاک نامعتبر است.' } }) ||
              validator.current.message("alphabet", alphabet, "") ||
...
export default UpdateBuyDirectly;
